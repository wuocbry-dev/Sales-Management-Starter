...
public class UserController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('USER_READ') or hasAnyRole('SUPER_ADMIN','ADMIN','STORE_MANAGER')")
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('USER_WRITE') or hasAnyRole('SUPER_ADMIN','ADMIN','STORE_MANAGER')")
