...
public class SalesOrderController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('POS_ORDER_CREATE') or hasAnyRole('ADMIN','STORE_MANAGER','STORE_OWNER')")
    ...
    @PreAuthorize("hasAuthority('POS_ORDER_COMPLETE') or hasAnyRole('ADMIN','STORE_MANAGER','STORE_OWNER')")
    ...
    @PutMapping("/{id}/hold")
    @PreAuthorize("hasAuthority('POS_ORDER_HOLD') or hasAnyRole('ADMIN','STORE_MANAGER','STORE_OWNER')")
    ...
    @PreAuthorize("hasAuthority('POS_ORDER_DISCOUNT') or hasAnyRole('ADMIN','STORE_MANAGER','STORE_OWNER')")
