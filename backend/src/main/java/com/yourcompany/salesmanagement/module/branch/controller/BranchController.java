...
public class BranchController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('BRANCH_READ') or hasAnyRole('SUPER_ADMIN','ADMIN','STORE_MANAGER','STORE_OWNER')")
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('BRANCH_WRITE') or hasAnyRole('SUPER_ADMIN','ADMIN','STORE_MANAGER','STORE_OWNER')")
